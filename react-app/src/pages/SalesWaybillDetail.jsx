...
const SalesWaybillDetail = () => {
    ...
    const [items, setItems] = useState([
        { id: 1, name: 'Örnek Ürün 1', kdv: 20, otv: 0, price: 1000, qty: 1, discount: 0, total: 1000, grandTotal: 1200 }
    ]);
    ...
    useEffect(() => {
        if (cariId) {
            ...
            if (found) {
                setCustomer({
                    name: found.name || found.cariAdi || 'Bilinmeyen Cari',
    ...
    const handleSaveWaybill = () => {
        if (!cariId) {
            alert('Lütfen irsaliyeyi kaydetmeden önce bir cari seçiniz!');
            return;
        }

        const salesWaybills = JSON.parse(localStorage.getItem('salesWaybills')) || [];
        const newWaybill = {
            ...waybillInfo,
        ...
        salesWaybills.push(newWaybill);
        localStorage.setItem('salesWaybills', JSON.stringify(salesWaybills));
    ...
    return (
        <div style={{ padding: '20px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <h2 style={{ margin: 0, color: '#333' }}>Satış İrsaliyesi Oluştur</h2>
                <button 
                    type="button"
                    onClick={() => navigate('/satis-irsaliye')}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '20px' }}>
                ...
                <div style={{ background: 'white', padding: '20px', borderRadius: '8px', border: '1px solid #ddd' }}>
                    <h3 style={{ marginTop: 0, fontSize: '1.1rem', borderBottom: '1px solid #eee', paddingBottom: '10px' }}>Cari Bilgileri</h3>
                ...
                <div style={{ background: 'white', padding: '20px', borderRadius: '8px', border: '1px solid #ddd' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                        ...
                        <div>
                            <label style={{ display: 'block', fontSize: '13px', fontWeight: 'bold', marginBottom: '4px' }}>Sevk Tarihi</label>
                        ...
                        <div style={{ gridColumn: 'span 2' }}>
                            <label style={{ display: 'block', fontSize: '13px', fontWeight: 'bold', marginBottom: '4px' }}>İrsaliye No</label>
...
export default SalesWaybillDetail;
