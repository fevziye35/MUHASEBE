...
prefix = html.split('<form id="stockForm" class="stock-form">')[0]
suffix = html.split('</form>')[-1]

new_form = """<form id="stockForm" class="stock-form">
                <!-- Barcode Section -->
...
with open('stok_yeni.html', 'w', encoding='utf-8') as f:
    f.write(prefix + new_form + "</form>" + suffix)

print("Restored with Python")
